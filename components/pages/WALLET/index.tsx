...
const WALLET = () => {
  return (
    <div className=" w-full xl:w-[81%] h-full flex gap-10">
      ...
      <aside className="flex-col p-4 rounded-[7px] justify-between right-0 left-0 top-0 overflow-hidden overflow-y-auto bg-card flex-none max-w-[280px] relative w-[19%] z-50 h-full hidden xl:flex"></aside>
    </div>
  );
};
