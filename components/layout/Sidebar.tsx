...
const Sidebar = () => {
  ...
  return (
    <aside className="flex-col max-w-[280px] rounded-[7px] justify-between right-0 left-0 top-0 overflow-hidden overflow-y-auto bg-card flex-none relative w-[19%] z-50 h-full hidden xl:flex">
